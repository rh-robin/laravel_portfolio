        ...
        <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form id="productForm" action="{{ route('products.update',['product' => $product->id]) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                            @csrf
                            @method('put')
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="name" class=" form-control-label">Product Name</label></div>
                                <div class="col-12 col-md-9">
                                    <input type="text" value="{{ old('name') ?? $product->name }}" id="name" name="name" placeholder="Product Name" class="form-control">
                                    @error('name')
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" value="{{ old('slug') ?? $product->slug }}" id="slug" name="slug" placeholder="Product Slug" class="form-control">
                                    @error('slug')
                                    <small style="color:red;">{{ $message }}</small>
                                    @endError
                                </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" value="{{ old('sku') ?? $product->sku }}" id="sku" name="sku" placeholder="Product SKU" class="form-control">
                                    @error('sku')
                                    <small style="color:red;">{{ $message }}</small>
                                    @endError
                                </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    ...
                                    <img class="mb-2" style="border-radius:5px;" src="{{ asset($product->image) }}" width="200px" alt="">
                                    <input type="file" value="{{ old('image') ?? $product->image }}" id="image" name="image" placeholder="Product Image" class="form-control">
                                    @error('image')
                                    <small style="color:red;">{{ $message }}</small>
                                    @endError
                                </div>
                            ...
                            <div class="row form-group" id="selectCategory">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="category" value="{{ old('category') }}" id="select" class="form-control">
                                        ...
                                        <option value="{{ $allCategory->id }}" {{ $product->category==$allCategory->id ? 'selected' : '' }}>{{ $allCategory->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('category')
                                    <small style="color:red;">{{ $message }}</small>
                            ...
                            <div class="row form-group" id="selectSubCategory">
                                ...
                                <div class="col-12 col-md-9">
                                    <select name="subcategory" value="{{ old('subcategory') }}" id="select" class="form-control">
                                        ...
                                        <option value="{{ $allSubCategory->id }}" {{ $product->subcategory==$allSubCategory->id ? 'selected' : '' }}>{{ $allSubCategory->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('subcategory')
                                    <small style="color:red;">{{ $message }}</small>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="number" value="{{ old('purchase_price') ?? $product->purchase_price }}" id="purchase_price" name="purchase_price" placeholder="Purchase Price" class="form-control">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="number" value="{{ old('sell_price') ?? $product->sell_price }}" id="sell_price" name="sell_price" placeholder="Sell Price" class="form-control">
                                    @error('sell_price')
                                    <small style="color:red;">{{ $message }}</small>
                                    @endError
                                </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="number" value="{{ old('quantity') ?? $product->quantity }}" id="quantity" name="quantity" placeholder="Product Quantity" class="form-control">
                                    @error('quantity')
                                    <small style="color:red;">{{ $message }}</small>
                                    @endError
                                </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea name="description" placeholder="Product Description" class="form-control" id="description" cols="30" rows="10">{{ old('description') ?? $product->description }}</textarea>
                                    @error('description')
                                    <small style="color:red;">{{ $message }}</small>
                                    @endError
                                </div>
