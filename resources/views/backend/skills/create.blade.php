                ...
                <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form id="categoryForm" action="{{ route('skills.store') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    @csrf
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" value="{{ old('percentage')}}" id="percentage" name="percentage" placeholder="Percentage" class="form-control">
                                            @error('percentage')
                                            <small style="color:red;">{{ $message }}</small>
                                            @endError
                                        </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" value="{{ old('bar_color')}}" id="bar_color" name="bar_color" placeholder="Progress Bar Color" class="form-control">
                                            @error('bar_color')
                                            <small style="color:red;">{{ $message }}</small>
                                            @endError
                                        </div>
