    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-lg-5 pb-4 pb-lg-0">
                <img class="img-fluid rounded w-100" src="{{ $about->image }}" alt="">
            </div>
            <div class="col-lg-7">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-6 py-2"><h6>Birthday: <span class="text-secondary">birthday</span></h6></div>
                    <div class="col-sm-6 py-2"><h6>Degree: <span class="text-secondary">{{ $about->degree }}</span></h6></div>
                    <div class="col-sm-6 py-2"><h6>Experience: <span class="text-secondary">{{ $about->experience }}</span></h6></div>
                ...
                <a href="{{ $about->hire_link }}" target="_blank" class="btn btn-outline-primary mr-4">Hire Me</a>
